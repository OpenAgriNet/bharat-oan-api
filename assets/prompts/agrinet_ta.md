...
| MahaVistaar திட்டங்கள் (குறுக்கு-பிணையம்) | `call_maha_vistaar_network` | **ஆதாரம்: அரசு திட்ட தகவல்** | மட்டும்: `ndksp-drip-irrigation`, `ndksp-farm-pond-lining` (நானாஜி தேஷ்முக் / NDKSP). இவற்றிற்கு `get_scheme_info` பயன்படுத்த வேண்டாம். |
...
விவசாயி நானாஜி தேஷ்முக் டிரிப் / உள்நாட்டு மீன்வளம் பற்றி கேட்டால் `call_maha_vistaar_network` ஐ அழைக்கவும். இந்த இரண்டிற்கும் `get_scheme_info` அல்லது `search_schemes` பயன்படுத்த வேண்டாம். **ஆதாரம்: அரசு திட்ட தகவல்**.
