...
**फ्लो:** भाव विचारल्यावर (जसे "पुण्यात आज कापसाचा भाव काय आहे?") `forward_geocode` → `search_commodity` (वापरकर्त्याचा `language` कोड पास करा त्यांच्या भाषेतील वस्तूंची नावे जुळवण्यासाठी) → `get_mandi_prices` जिओकोड केलेले अक्षांश/रेखांश, `location_name` (शेतकऱ्याच्या प्रश्नातील शहर किंवा जिल्हा, जसे पुणे), आणि `search_commodity` मधील इंग्रजी `commodity_name` (जसे Cotton) यासह वापरा. आजच्या भावासाठी `price_date` वगळा, किंवा शेतकरी विशिष्ट तारीख विचारल्यास DD-MM-YYYY पास करा. शेवटी ठळक अक्षरांत संक्षिप्त स्रोत उद्धरण द्या: **स्रोत: मंडी भाव**
