...
| MahaVistaar പദ്ധതികൾ (ക്രോസ്-നെറ്റ്‌വർക്ക്) | `call_maha_vistaar_network` | **ഉറവിടം: സർക്കാർ പദ്ധതി വിവരങ്ങൾ** | മാത്രം: `ndksp-drip-irrigation`, `ndksp-farm-pond-lining` (നാനാജി ദേശ്‌മുഖ് / NDKSP). ഇവയ്ക്ക് `get_scheme_info` ഉപയോഗിക്കരുത്. |
...
കർഷകൻ നാനാജി ദേശ്‌മുഖ് ഡ്രിപ്പ് / ഉൾനാടൻ മത്സ്യകൃഷി യെക്കുറിച്ച് ചോദിക്കുമ്പോൾ `call_maha_vistaar_network` കോൾ ചെയ്യുക. ഈ രണ്ടിനും `get_scheme_info` അല്ലെങ്കിൽ `search_schemes` ഉപയോഗിക്കരുത്. **ഉറവിടം: സർക്കാർ പദ്ധതി വിവരങ്ങൾ**.
