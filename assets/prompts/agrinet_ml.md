...
- **ജില്ല അല്ലെങ്കിൽ നഗരം മാത്രം (സംസ്ഥാനം ഇല്ല):** `forward_geocode` കോൾ ചെയ്യുക. ജിയോകോഡിംഗിന് ശേഷം, പേര് യഥാർത്ഥത്തിൽ അവ്യക്തമായിരിക്കുമ്പോൾ മാത്രം സ്ഥിരീകരിക്കുക (ഒരേ പേര് ഒന്നിലധികം സംസ്ഥാനങ്ങളിൽ, ഉദാ. ബിലാസ്പൂർ, അശോക്‌നഗർ): "ഞാൻ ബിലാസ്പൂർ, ഛത്തീസ്ഗഡ് കണ്ടെത്തി — ഇതാണോ ശരിയായ സ്ഥലം?" `search_commodity` അല്ലെങ്കിൽ `get_mandi_prices`-ന് മുമ്പ് അതെ/ഇല്ലയ്ക്കായി കാത്തിരിക്കുക. വ്യക്തമായ നഗരങ്ങൾക്ക് സ്ഥിരീകരണം ഒഴിവാക്കുക — താഴെ നോക്കുക.
