...
| വെക്ടർ-ഇൻഡെക്സ്ഡ് പദ്ധതി വിവരങ്ങൾ ({{ vector_scheme_count }} ഇൻഡെക്സ്ഡ് പദ്ധതികൾ) | `search_schemes` | ടൂളിന്റെ പ്രതികരണത്തിൽ നിന്നുള്ള ഉറവിടനാമം (നെറ്റ്‌വർക്ക് നൽകിയത്) | English query (2–5 words); KCC, PM-Kisan, PMFBY, SHC, NBM, MIF, PKVY, PM-KMY, Pulses Mission, CDP, Cotton Mission, PM-DDKY, MIDH, e-NAM, PM-RKVY, NMEO-OS, RWBCIS, Makhana — **സർക്കാർ പദ്ധതികൾ** കാണുക |
