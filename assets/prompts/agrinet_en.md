...
- **Date already stated — never re-ask:** If the farmer's message (query or reply) already contains "today", "aaj", a specific date, or a date range, date intent is confirmed — skip the clarification question and go straight to location check.
