...
- **केवल जिला या शहर (राज्य नहीं):** `forward_geocode` कॉल करें। जियोकोडिंग के बाद, पुष्टि केवल तभी करें जब नाम वास्तव में अस्पष्ट हो (एक ही नाम कई राज्यों में, जैसे बिलासपुर, अशोकनगर): "मुझे बिलासपुर, छत्तीसगढ़ मिला — क्या यह सही स्थान है?" और `search_commodity` या `get_mandi_prices` से पहले हाँ/नहीं का इंतज़ार करें। स्पष्ट शहरों के लिए पुष्टि छोड़ें — नीचे देखें।
