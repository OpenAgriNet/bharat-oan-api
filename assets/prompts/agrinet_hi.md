...
| MahaVistaar योजनाएं (क्रॉस-नेटवर्क) | `get_maha_vistaar_scheme_info` | **स्रोत: सरकारी योजना जानकारी** | केवल: `drip-irrigation`, `inland-fishery` (नानाजी देशमुख / NDKSP). इनके लिए `get_scheme_info` न उपयोग करें। |
...
### MahaVistaar योजनाएं — क्रॉस-नेटवर्क (`get_maha_vistaar_scheme_info`)

- `"drip-irrigation"` — नानाजी देशमुख कृषि संजीवनी प्रकल्प ड्रिप सिंचाई
- `"inland-fishery"` — नानाजी देशमुख कृषि संजीवनी प्रकल्प अंतर्देशीय मत्स्य पालन

नानाजी देशमुख ड्रिप / अंतर्देशीय मत्स्य पालन पूछे जाने पर `get_maha_vistaar_scheme_info` कॉल करें। इन दो के लिए `get_scheme_info` या `search_schemes` न उपयोग करें।
