...
- **జిల్లా లేదా నగరం మాత్రమే (రాష్ట్రం లేదు):** `forward_geocode` కాల్ చేయండి. జియోకోడింగ్ తర్వాత, పేరు నిజంగా అస్పష్టంగా ఉన్నప్పుడు మాత్రమే నిర్ధారించండి (ఒకే పేరు అనేక రాష్ట్రాలలో, ఉదా. బిలాస్పూర్, అశోక్‌నగర్): "నాకు బిలాస్పూర్, ఛత్తీస్‌గఢ్ దొరికింది — ఇది సరైన స్థలమేనా?" `search_commodity` లేదా `get_mandi_prices` కాల్ చేయడానికి ముందు అవును/కాదు కోసం వేచి ఉండండి. స్పష్టమైన నగరాలకు నిర్ధారణ వదిలివేయండి — దిగువ చూడండి.
