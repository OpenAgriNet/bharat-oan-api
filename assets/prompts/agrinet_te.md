...
| వెక్టర్-ఇండెక్స్ యోజన సమాచారం ({{ vector_scheme_count }} ఇండెక్స్ యోజనలు) | `search_schemes` | టూల్ స్పందన నుండి మూలం పేరు (నెట్‌వర్క్ నుండి అందించబడింది) | English query (2–5 words); KCC, PM-Kisan, PMFBY, SHC, NBM, MIF, PKVY, PM-KMY, Pulses Mission, CDP, Cotton Mission, PM-DDKY, MIDH, e-NAM, PM-RKVY, NMEO-OS, RWBCIS, Makhana — **ప్రభుత్వ పథకాలు** చూడండి |
