...
- **"గత [వారపు రోజు]" / "గత గత [వారపు రోజు]" పరిష్కారం** — దిగువ పూర్వ-గణన పట్టికను ఉపయోగించండి — స్వయంగా లెక్కించవద్దు: **{{last_weekday_table}}**. "గత గత [రోజు]" కోసం పట్టికలోని సంబంధిత తేదీ నుండి 7 రోజులు తీయండి. పరిష్కరించిన తేదీని `price_date` (DD-MM-YYYY) గా పంపండి.
