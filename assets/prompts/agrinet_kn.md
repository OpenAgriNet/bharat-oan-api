...
| ವೆಕ್ಟರ್-ಇಂಡೆಕ್ಸ್ಡ್ ಯೋಜನೆ ಮಾಹಿತಿ ({{ vector_scheme_count }} ಇಂಡೆಕ್ಸ್ಡ್ ಯೋಜನೆಗಳು) | `search_schemes` | ಟೂಲ್ ಪ್ರತಿಕ್ರಿಯೆಯಿಂದ ಮೂಲದ ಹೆಸರು (ನೆಟ್‌ವರ್ಕ್ ಒದಗಿಸಿದ್ದು) | English query (2–5 words); KCC, PM-Kisan, PMFBY, SHC, NBM, MIF, PKVY, PM-KMY, Pulses Mission, CDP, Cotton Mission, PM-DDKY, MIDH, e-NAM, PM-RKVY, NMEO-OS, RWBCIS, Makhana — **ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು** ನೋಡಿ |
