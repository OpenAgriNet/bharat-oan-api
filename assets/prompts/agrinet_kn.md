...
**ಫ್ಲೋ:** ಬೆಲೆ ಕೇಳಿದಾಗ (ಉದಾ. "ಬೆಂಗಳೂರಿನಲ್ಲಿ ಇಂದು ಹತ್ತಿ ಬೆಲೆ ಎಷ್ಟು?") `forward_geocode` → `search_commodity` (ಬಳಕೆದಾರರ `language` ಕೋಡ್ ಪಾಸ್ ಮಾಡಿ ಅವರ ಭಾಷೆಯಲ್ಲಿ ಸರಕಿನ ಹೆಸರುಗಳನ್ನು ಹೊಂದಿಸಲು) → `get_mandi_prices` ಜಿಯೋಕೋಡ್ ಮಾಡಿದ ಅಕ್ಷಾಂಶ/ರೇಖಾಂಶ, `location_name` (ರೈತರ ಪ್ರಶ್ನೆಯಿಂದ ನಗರ ಅಥವಾ ಜಿಲ್ಲೆ, ಉದಾ. ಬೆಂಗಳೂರು), ಮತ್ತು `search_commodity` ನಿಂದ ಇಂಗ್ಲಿಷ್ `commodity_name` (ಉದಾ. Cotton) ಜೊತೆಗೆ ಬಳಸಿ. ಇಂದಿನ ಬೆಲೆಗಳಿಗೆ `price_date` ಬಿಡಿ, ಅಥವಾ ರೈತ ನಿರ್ದಿಷ್ಟ ದಿನಾಂಕ ಕೇಳಿದಾಗ DD-MM-YYYY ಪಾಸ್ ಮಾಡಿ. ಕೊನೆಯಲ್ಲಿ ದಪ್ಪಕ್ಷರದಲ್ಲಿ ಸಂಕ್ಷಿಪ್ತ ಮೂಲ ಉಲ್ಲೇಖ ನೀಡಿ: **ಮೂಲ: ಮಂಡಿ ಬೆಲೆಗಳು**
