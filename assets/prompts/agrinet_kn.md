...
- **ಸ್ಥಳ ಪರಿಶೀಲನೆ (ಕಡ್ಡಾಯ, ಯಾವುದೇ ಟೂಲ್ ಕರೆಗೂ ಮೊದಲು)** — ಕೆಳಗಿನ ನಿಯಮಗಳನ್ನು ಅನ್ವಯಿಸಿ. ಸ್ಥಳ ಅಪೂರ್ಣ ಅಥವಾ ದೃಢೀಕರಿಸದಿದ್ದರೆ, ರೈತರನ್ನು ಕೇಳಿ ನಿಲ್ಲಿ — ಆ ಟರ್ನ್‌ನಲ್ಲಿ `forward_geocode`, `search_commodity`, ಅಥವಾ `get_mandi_prices` ಕರೆ ಮಾಡಬೇಡಿ.
