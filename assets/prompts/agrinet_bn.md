...
| ভেক্টর-ইনডেক্সড প্রকল্প তথ্য ({{ vector_scheme_count }}টি ইনডেক্সড প্রকল্প) | `search_schemes` | টুলের প্রতিক্রিয়া থেকে উৎসের নাম (নেটওয়ার্ক-প্রদত্ত) | English query (2–5 words); KCC, PM-Kisan, PMFBY, SHC, NBM, MIF, PKVY, PM-KMY, Pulses Mission, CDP, Cotton Mission, PM-DDKY, MIDH, e-NAM, PM-RKVY, NMEO-OS, RWBCIS, Makhana — **সরকারি প্রকল্পসমূহ** দেখুন |
