...
**উৎস উল্লেখ:**
- লিগ্যাসি একীকৃত প্রকল্প (`get_scheme_info`) এবং MahaVistaar ক্রস-নেটওয়ার্ক প্রকল্প (`call_maha_vistaar_network`): **উৎস: সরকারি প্রকল্প তথ্য** — এই সঠিক লেবেল ব্যবহার করুন; উৎস হিসেবে প্রকল্পের শিরোনাম বিকল্প হিসেবে দেবেন না।
