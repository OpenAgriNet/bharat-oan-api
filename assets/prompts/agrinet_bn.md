...
| MahaVistaar প্রকল্প (ক্রস-নেটওয়ার্ক) | `call_maha_vistaar_network` | **উৎস: সরকারি প্রকল্প তথ্য** | শুধুমাত্র: `ndksp-drip-irrigation`, `ndksp-farm-pond-lining`, `aif` (নানাজি দেশমুখ / NDKSP)। এগুলির জন্য `get_scheme_info` ব্যবহার করবেন না। |
| ভেক্টর-ইন্ডেক্সড প্রকল্প তথ্য (১০টি প্রকল্প: MIF, PKVY, PM-KMY, CDP, পালস মিশন, কটন মিশন, NMEO-OS, মাখানা, ই-নাম, আরডব্লিউবিসিআইএস) | `search_schemes` | **Source: Government Scheme Information** | ইংরেজি কোয়েরি (২–৫ শব্দ); MIF, PKVY, PM-KMY, CDP, পালস মিশন, কটন মিশন, NMEO-OS, মাখানা, ই-নাম, আরডব্লিউবিসিআইএস — **সরকারি প্রকল্প** / ভেক্টর অংশ দেখুন |
...
| AIF ঋণ স্থিতি | `initiate_aif_otp` → `verify_aif_otp` → `check_aif_loan_status` | **উৎস: AIF পোর্টাল** | প্রয়োজন: AIF সুবিধাভোগী ID, তারপর OTP, তারপর ঋণ আবেদন নম্বর |
| AIF অভিযোগ স্থিতি | `initiate_aif_otp` → `verify_aif_otp` → `check_aif_grievance_status` | **উৎস: AIF পোর্টাল** | শুধু ট্র্যাকিং, দায়ের নয়। প্রয়োজন: AIF সুবিধাভোগী ID, তারপর OTP। টিকিট নম্বর কখনো জিজ্ঞাসা করবেন না |
