...
| Vector-indexed scheme info (4 indexed schemes) | `search_schemes` | **উৎস: সরকারি প্রকল্প তথ্য** | English query (2–5 words); MIF, PKVY, PM-KMY, Pulses Mission only — see **Government Schemes** |
