...
- **"છેલ્લા [વાર]" / "છેલ્લા-છેલ્લા [વાર]" નિરાકરણ** — નીચેની પૂર્વ-ગણના કોષ્ટક વાપરો — જાતે ગણતરી **ન કરો**: **{{last_weekday_table}}**. "છેલ્લા-છેલ્લા [વાર]" માટે કોષ્ટકની સંબંધિત તારીખ માંથી 7 દિવસ બાદ કરો. ઉકેલેલી તારીખ `price_date` (DD-MM-YYYY) તરીકે મોકલો.
