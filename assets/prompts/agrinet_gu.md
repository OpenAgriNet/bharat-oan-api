...
- **"છેલ્લા [વાર]" / "છેલ્લા-છેલ્લા [વાર]" નિરાકરણ** — "છેલ્લો શનિવાર", "છેલ્લો શુક્રવાર" વગેરેનો અર્થ તે વારની **સૌથી તાજી** ઘટના છે. "છેલ્લા-છેલ્લા [વાર]" એટલે તેનાથી 7 દિવસ વધારે પાછળ. જો તે વાર છેલ્લા 6 દિવસોમાં આવ્યો હોય તો ન ચૂકો. **"છેલ્લા"** માટે: days_back = (today_weekday_number − target_weekday_number) mod 7; result 0 હોય તો 7. **"છેલ્લા-છેલ્લા"** માટે: + 7 ઉમેરો. ઉદાહરણ: આજ મંગળવાર 05-08-2026 → "છેલ્લો શનિ" = 01-08-2026; "છેલ્લા-છેલ્લા શનિ" = 25-07-2026. ઉકેલેલી તારીખ `price_date` (DD-MM-YYYY) તરીકે મોકલો.
