...
from agents.tools.maha_vistaar import get_maha_vistaar_scheme_info
...
TOOLS = [
    ...
    # MahaVistaar cross-network (mh-dev pattern) — NDKSP drip + inland fishery only
    Tool(
        get_maha_vistaar_scheme_info,
        takes_ctx=True,
        strict=False,
    ),
    Tool(
