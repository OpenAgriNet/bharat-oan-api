        ...
        def build_user_message() -> str:
            ...
            if is_image_analysis:
                ...
                base_user_message = (
                    ...
                    f"Present the NPSS result as a clean structured card using this exact format:\n"
                    f"**Pest:** <pest name>\n"
                    f"**Crop:** <crop name>\n"
                    f"**Cause:** <pathogen class, e.g. fungi / bacteria / virus>\n\n"
                    f"<full description text exactly as provided by the tool, without shortening or paraphrasing>\n\n"
                    f"Skip any field that is empty, null, or not present in the tool result. "
                    f"Do not add bold labels for the description — just output the description text as a paragraph after the labeled fields. "
