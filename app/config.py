...
class Settings(BaseSettings):
    ...
    npss_geocode_map_path: Optional[str] = os.getenv("NPSS_GEOCODE_MAP_PATH")
    npss_allow_default_location: bool = os.getenv("NPSS_ALLOW_DEFAULT_LOCATION", "").strip().lower() in (
        "1",
        "true",
        "yes",
        "on",
